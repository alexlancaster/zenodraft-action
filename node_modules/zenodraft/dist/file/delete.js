...
exports.file_delete = exports.file_delete_by_fileid = void 0;
...
const file_delete_by_fileid = (sandbox, id, fileid, verbose = false) => __awaiter(void 0, void 0, void 0, function* () {
    if (verbose) {
    ...
    try {
        ...
        response = yield node_fetch_1.default(`${files}/${fileid}`, init);
        if (response.ok !== true) {
            throw new Error();
        }
    }
...
exports.file_delete_by_fileid = file_delete_by_fileid;
